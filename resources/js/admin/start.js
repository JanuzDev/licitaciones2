let charts = () => {
    ...
    var KTApexChartsDemo = (function () {
        ...
        var _demo4 = function () {
            ...
            let data = [];
            let values = $(apexChart).data("info");
            if (values) {
                data.push(values.data.inits, values.data.verifies);
            }
            var options = {
                series: data,
                chart: {
                ...
                xaxis: {
                    categories: values ? values.years : [],
                    labels: {
                        formatter: function (val) {
                            return val + "";
                        },
                ...
                colors: [primary, success, danger, warning, danger, info],
            };
        ...
        var _demo12 = function () {
            ...
            let values = $("#chart_12").data("info");
            if (values) {
                let data = values.map((v) => v.value);
                data = data.filter((v) => v == 0).length == 3 ? [] : data;
                var options = {
                    series: data,
                    chart: {
                        height: 360,
                    ...
                    noData: {
                        text: "Aún no existen datos para mostrar",
                        align: "center",
